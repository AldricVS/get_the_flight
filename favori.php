...
<body>
	...
	<div class="row main-content">
		<main class="col-md-9">
			<section>
				<h2>Vols favoris de <?= $_SESSION["username"] ?></h2>
				<form class="centered">
					<div id="flights">
						<?php
						...
						for ($i = 0; $i < $user_favorites_routes_lenght; $i++) {
							...
							echo '<p><span class="travel-airport-begin">' . $departureAirport . '</span> ⇨ <span class="travel-airport-end">' . $arrivalAirport . '</span></p>' . "\n\t";
							echo '<button type="button" class="rechercher-fav-button">Rechercher</button>'  . "\n\t";
